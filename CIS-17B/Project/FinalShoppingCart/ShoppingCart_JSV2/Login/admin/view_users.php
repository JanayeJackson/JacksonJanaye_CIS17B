<?php
/* 
 * script:   view_user.php
 * Author: Janaye Jackson
 *
 * Created on May 28th, 2024, 9:52 PM
 * Purpose: This script retrieves all the records from the users table.
...
echo '<h1>Registered Users</h1>';
    ...
    if (isset($_GET['p']) && is_numeric($_GET['p'])) { // Already been determined.
        ...
        // Define the query:
        $q = "SELECT last_name, first_name, user_name, DATE_FORMAT(registration_date, '%M %d, %Y') AS dr, user_id FROM users ORDER BY $order_by LIMIT $start, $display";		
        ...
        <tr>
            ...
            <td align="left"><b><a href="view_users.php?sort=us">Username</a></b></td>
		...
		echo '<tr bgcolor="' . $bg . '">
                <td align="left"><a href="edit_user.php?id=' . $row['user_id'] . '&user=' . $user .'">Edit</a></td>
		<td align="left"><a href="delete_user.php?id=' . $row['user_id'] . '&user='.$user.'">Delete</a></td>
